namespace GymManagement.API.Trainer.DTOs
{
    ...
    // DTO tạo buổi tập PT mới
    public class CreateBuoiTapPTDto
    {
        public int LichDayId { get; set; }
        public int HocVienId { get; set; }
        public DateTime NgayTap { get; set; }
        ...
        public int SoSet { get; set; }
        public int SoRep { get; set; }
        public double? CanNangSuDung { get; set; }
    }

    // DTO cập nhật buổi tập PT
    public class UpdateBuoiTapPTDto
    {
        public string? TrangThai { get; set; }
        public string? NoiDungBuoiTap { get; set; }
        public string? BaiTap { get; set; }
        public int? SoSet { get; set; }
        public int? SoRep { get; set; }
        public double? CanNangSuDung { get; set; }
        public string? DanhGiaTrainer { get; set; }
        public string? GhiChuHocVien { get; set; }
    }

    // DTO check-in buổi tập
    public class CheckInBuoiTapDto
    {
        public int BuoiTapId { get; set; }
        public DateTime ThoiGianCheckIn { get; set; }
    }

    // DTO check-out và đánh giá buổi tập
    public class CheckOutBuoiTapDto
    {
        public int BuoiTapId { get; set; }
        public DateTime ThoiGianCheckOut { get; set; }
        public string? DanhGiaTrainer { get; set; }
